...
CreateThread(function()
    Wait(3500)
    QBCore.Functions.TriggerCallback('bb-garages:server:getConfig', function(serverConfig, isAuthorized, lmfao)
...
AddEventHandler('bb-garages:client:GetPlayerCoords', function(trigger, params, lmfao)
    if lmfao then
        TriggerServerEvent(trigger, GetEntityCoords(PlayerPedId()), GetEntityHeading(PlayerPedId()), params, exports['kwk-houses']:GetClosestHouse())
    else
